...
[![ci](https://github.com/asharikov90/devops-for-developers-project-74/actions/workflows/push.yml/badge.svg)](https://github.com/asharikov90/devops-for-developers-project-74/actions/workflows/push.yml)
...
1. Клонируйте репозиторий:
   ```bash
   git clone git@github.com:asharikov90/devops-for-developers-project-74/.git
   cd js-fastify-blog
   ```
